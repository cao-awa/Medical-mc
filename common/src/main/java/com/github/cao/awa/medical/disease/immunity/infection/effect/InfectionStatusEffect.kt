...
class InfectionStatusEffect(statusEffectCategory: StatusEffectCategory?, i: Int): StatusEffect(statusEffectCategory, i) {
    ...
    companion object {
        const val FLOWER_CONTACT_EFFECT_DURATION: Int = 25
    }
}
